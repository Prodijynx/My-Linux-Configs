...
hl.exec_cmd("waybar & hyprpaper & /usr/lib/polkit-kde-authentication-agent-1")
end)
...
hl.config({
    ...
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(cdd6f4ee)"}, angle = 45 },
...
hl.config({
	...
	accel_profile = "flat",
        sensitivity = -0.59, -- -1.0 - 1.0, 0 means no modification.
...
-- Take screenshots :DDDDDD
hl.bind(mainMod .. " + ALT + S", hl.dsp.exec_cmd(screenshot))
...
-- Fix scaling issue with XWayland
-- force_zero_scaling = True
